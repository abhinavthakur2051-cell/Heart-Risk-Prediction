...
if st.button("← Back to Home"):
    # Change "home.py" or "index.py" to whatever your main file is named
...
with tab1:
    ...
    Leveraging advanced Artificial Intelligence and Machine Learning models, our platform provides quick, accessible, and secure health risk assessments. We believe that preventive healthcare should be available to everyone, everywhere.
