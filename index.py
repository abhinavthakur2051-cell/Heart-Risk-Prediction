...
with footer_col1:
    st.markdown("""
    <div style='color: #a0aec0; font-size: 15px; padding-top: 10px;'>
        <strong>© 2026 Heart Disease Risk Analyzer.</strong><br>
        All Rights Reserved.
    </div>
    """, unsafe_allow_html=True)
...
with footer_col2:
    ...
    # Using Streamlit page links for internal routing
    st.page_link("pages/content.py", label="About Us", icon="🏢")
    st.page_link("pages/content.py", label="Terms & Conditions", icon="📜")
    st.page_link("pages/content.py", label="Privacy Policy", icon="🔒")
    st.markdown("</div>", unsafe_allow_html=True)

with footer_col3:
    st.markdown("""
    <div style='text-align: right; color: #a0aec0; font-size: 15px; padding-top: 10px;'>
        <strong>Contact Us</strong><br>
        <a href='mailto:bmw41887@gmail.com' class='footer-link'>✉️ bmw41887@gmail.com</a>
    </div>
    """, unsafe_allow_html=True)
import streamlit as st
